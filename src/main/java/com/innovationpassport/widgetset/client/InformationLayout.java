...
public class InformationLayout extends VerticalComponentGroupWidget {
    ...
    public InformationLayout(final TicketViewModuleListener listener) {
        ...
        areaBox.addItem("dolnośląskie", "dolnośląskie");
        areaBox.addItem(" kujawsko-pomorskie", " kujawsko-pomorskie");
        areaBox.addItem("lubelskie", "lubelskie");
        areaBox.addItem("lubuskie", "lubuskie");
        areaBox.addItem("łódzkie", "łódzkie");
        areaBox.addItem("małopolskie", "małopolskie");
        areaBox.addItem("mazowieckie", "mazowieckie");
